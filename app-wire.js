...
//    - Myweb에서 <script type="module" src="...@prod/app-wire.js?v=YYYY-MM-DD-NN"> 로 불렀다면
...
function getDivorceCareType() {
  return $1('#divorceCareChips .chip.active')?.dataset.care || null;
}
